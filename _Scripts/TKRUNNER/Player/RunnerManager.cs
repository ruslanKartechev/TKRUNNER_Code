...
public class RunnerManager : MonoBehaviour
{
   ...
   // private MovementData data;
    ...
    public virtual void InitActive(SplineComputer spline)
    {
        ...
        SetupFollower();
        //if(playIdle)
            mAnim.Play(AnimNames.DummyIdle, BaseAnimLayer, Random.Range(0, 0.5f));
    ...
    public async Task StartMoving(bool blendAnim = true, bool playAnim = true)
    {
        ...
        {
            if (playAnim == true)
                mAnim.Play(AnimNames.DummyRun, BaseAnimLayer, (float)Random.Range(0f, 1f));
            if (movementStart.Token.IsCancellationRequested == false)
                StartSplineMovement();
        }
    }
    public virtual void StartImmidiate()
    {
        IsRunning = true;
        follower.enabled = true;
    ...
    {
        mAnim.Play(AnimNames.IdleRunTree, BaseAnimLayer, Random.Range(0,0.5f));
    ...
    protected virtual void StartSplineMovement()
    {
        IsRunning = true;
        mAnim.Play(AnimNames.DummyRun, BaseAnimLayer, (float)Random.Range(0f, 1f));
        follower.followSpeed = mainSpeed * speedModifier;
    ...
    {
        mAnim.Play(AnimNames.Win, BaseAnimLayer, Random.Range(0f, 1f));
    }
    public virtual void PlayDefeatAnim()
    {
        mAnim.Play(AnimNames.Defeat, BaseAnimLayer, Random.Range(0f, 1f));
